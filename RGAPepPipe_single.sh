...
# fastqc
/opt/PepPrograms/FastQC-0.11.8/fastqc -t 4 $1_1.fastq.gz

# trimGalore
/opt/PepPrograms/TrimGalore-0.6.4/trim_galore -q 15 --fastqc_args '-t 4' $1_1.fastq.gz
rm $1_?.fastq.gz

# bwaMEM
/opt/PepPrograms/bwa-0.7.12/bwa mem -M -t 8 $2 $1_1_trimmed.fq.gz  > $1.sam
...
# vcf_pilon
java -jar /opt/PepPrograms/pilon-1.16.jar --genome $2 --unpaired $1.realn.bam --output $1_pilon --variant --mindepth 10 --minmq 40 --minqual 20
